...
# if you decided to run the code again, you need to create a new inv_repo and med_repo data. Skip everything related to these data and consider a new count value based on the data you have. Run the remaining part of the code. 
